                ...
                <div className="bg-white rounded-lg shadow-md overflow-hidden">
                  ...
                  <div className="p-6 space-y-4">
                    ...
                    <button 
                      ...
                      className="w-full bg-accent-500 hover:bg-accent-600 text-white font-bold py-3 rounded-md transition-colors mt-4 flex items-center justify-center"
                    >
...
const EmptyCart: React.FC = () => {
  return (
    <div className="text-center py-12 bg-white rounded-lg shadow-md">
      ...
      <Link 
        to="/shop" 
        className="bg-accent-500 hover:bg-accent-600 text-white font-bold py-3 px-8 rounded-md transition-colors inline-block"
      >
        Start Shopping
      </Link>
    </div>
